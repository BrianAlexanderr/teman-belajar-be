...
public class AuthCustomExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> refreshTokenNotFoundException(OtpNotValidException ex){
        ErrorResponse errorResponse = new ErrorResponse(
                HttpStatus.NOT_FOUND.value(),
                ex.getMessage(),
                LocalDateTime.now().toString()
    ...
    public ResponseEntity<ErrorResponse> refreshTokenNotFoundException(SamePasswordException ex){
        ErrorResponse errorResponse = new ErrorResponse(
                HttpStatus.BAD_REQUEST.value(),
                ex.getMessage(),
                LocalDateTime.now().toString()
    ...
    public ResponseEntity<ErrorResponse> wrongTokenTypeException(WrongTokenTypeException ex){
        ErrorResponse errorResponse = new ErrorResponse(
                HttpStatus.BAD_REQUEST.value(),
                ex.getMessage(),
                LocalDateTime.now().toString()
    ...
    public ResponseEntity<ErrorResponse> tokenNotValidException(TokenNotValid ex){
        ErrorResponse errorResponse = new ErrorResponse(
                HttpStatus.BAD_REQUEST.value(),
                ex.getMessage(),
                LocalDateTime.now().toString()
